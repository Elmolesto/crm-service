...
RSpec.describe "Customer endpoints", type: :request do
  ...
  it "Get all customers (/v1/customers)" do
  ...
  it "Get one customer (/v1/customers/:id)" do
    get("/v1/customers/#{customer.id}", headers:)
  ...
  it "Update customer data (/v1/customers/:id)" do
    ...
    patch("/v1/customers/#{customer.id}", params: { customer: new_attributes }, headers:)
  ...
  it "Delete customer (/v1/customers/:id)" do
    expect do
      delete "/v1/customers/#{customer.id}", headers:
    end.to change(Customer, :count).by(-1)
